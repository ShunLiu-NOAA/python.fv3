...
PROD_DIR = '/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+ymd+'/'+cyc
PARA_DIR = '/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+ymd+'/'+cyc
...
#for j in range(len(vtime_list[0:7])):
    ...
    # Prod, para
    data1 = pygrib.open(PROD_DIR+'/fv3lam.t'+cyc+'z.conus.f'+fhour+'.grib2')
    data2 = pygrib.open(PARA_DIR+'/fv3lam.t'+cyc+'z.conus.f'+fhour+'.grib2')
