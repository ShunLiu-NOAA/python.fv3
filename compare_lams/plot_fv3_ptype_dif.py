...
for j in range(len(date_list)):
  ...
  prodind = pygrib.index('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhr+'.grib2','name','level')
  paraind = pygrib.index('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhr+'.grib2','name','level')
