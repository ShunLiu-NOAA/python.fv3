...
# Define the input files - different based on which domain you are reading in!
  data1 = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.'+dom+'.f'+fhour+'.grib2')
  datagoes = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.rrfsgoestb.f'+fhour+'.grib2')

  if (fhr > 2):
    data1_m1 = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.'+dom+'.f'+fhour1+'.grib2')
    data1_m2 = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.'+dom+'.f'+fhour2+'.grib2')
  if (fhr >= 6):
    data1_m6 = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.'+dom+'.f'+fhour6+'.grib2')
  if (fhr >= 24):
    data1_m24 = pygrib.open('/gpfs/dell6/ptmp/emc.campara/fv3lamx/fv3lamx.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.'+dom+'.f'+fhour24+'.grib2')


# Sea level pressure
  slp_1 = data1.select(name='Pressure reduced to MSL')[0].values * 0.01
  slpsmooth1 = ndimage.filters.gaussian_filter(slp_1, 13.78)
  slpsmooth1[slpsmooth1 > 2000] = 0	# Mask out undefined values on domain edge
...
# GOES-16 brightness temperatures
  ...
  return slp_1,slpsmooth1,tmp2m_1,tmpsfc_1,dew2m_1,uwind_1,vwind_1,wspd10m_1,terra_1,gust_1,mucape_1,mucin_1,cape_1,sfcin_1,mlcape_1,mlcin_1,thetae_1,u850_1,v850_1,omg700_1,rh700_1,z500_1,vort500_1,u500_1,v500_1,u250_1,v250_1,wspd250_1,visemc_1,visgsd_1,zbase_1,zceil_1,ztop_1,pw_1,pofp_1,qpf_1,qpf3_1,snow_1,snow6_1,ref1km_1,refc_1,clwmr_1,icmr_1,rwmr_1,snmr_1,grle_1,refd_1,tmphyb_1,sotyp_1,vgtyp_1,veg_1,tsoil_0_10_1,tsoil_10_40_1,tsoil_40_100_1,tsoil_100_200_1,soilw_0_10_1,soilw_10_40_1,soilw_40_100_1,soilw_100_200_1,swdown_1,swup_1,lwdown_1,lwup_1,gdhfx_1,lhfx_1,snhfx_1,hpbl_1,cond_1,tcolw_1,tcoli_1,hel3km_1,hel1km_1,uh25_1,uh03_1,maxuvv_1,maxdvv_1,maxref1km_1,maxref10C_1,maxwind_1,relv01_1,relv02_1,relvhyb_1,hindex_1,utrans_1,vtrans_1,trans_1,tcdc_1,retop_1,pbase_1,ptop_1,prate_1,tb_ch8,tb_ch9,tb_ch10,tb_ch13
...
def plot_all(domain):
  ...
  global slp_1,slpsmooth1,tmp2m_1,tmpsfc_1,dew2m_1,uwind_1,vwind_1,wspd10m_1,terra_1,gust_1,mucape_1,mucin_1,cape_1,sfcin_1,mlcape_1,mlcin_1,thetae_1,u850_1,v850_1,omg700_1,rh700_1,z500_1,vort500_1,u500_1,v500_1,u250_1,v250_1,wspd250_1,visemc_1,visgsd_1,zbase_1,zceil_1,ztop_1,pw_1,pofp_1,qpf_1,qpf3_1,snow_1,snow6_1,ref1km_1,refc_1,clwmr_1,icmr_1,rwmr_1,snmr_1,grle_1,refd_1,tmphyb_1,sotyp_1,vgtyp_1,veg_1,tsoil_0_10_1,tsoil_10_40_1,tsoil_40_100_1,tsoil_100_200_1,soilw_0_10_1,soilw_10_40_1,soilw_40_100_1,soilw_100_200_1,swdown_1,swup_1,lwdown_1,lwup_1,gdhfx_1,lhfx_1,snhfx_1,hpbl_1,cond_1,tcolw_1,tcoli_1,hel3km_1,hel1km_1,uh25_1,uh03_1,maxuvv_1,maxdvv_1,maxref1km_1,maxref10C_1,maxwind_1,relv01_1,relv02_1,relvhyb_1,hindex_1,utrans_1,vtrans_1,trans_1,tcdc_1,retop_1,pbase_1,ptop_1,prate_1,tb_ch8,tb_ch9,tb_ch10,tb_ch13

  slp_1,slpsmooth1,tmp2m_1,tmpsfc_1,dew2m_1,uwind_1,vwind_1,wspd10m_1,terra_1,gust_1,mucape_1,mucin_1,cape_1,sfcin_1,mlcape_1,mlcin_1,thetae_1,u850_1,v850_1,omg700_1,rh700_1,z500_1,vort500_1,u500_1,v500_1,u250_1,v250_1,wspd250_1,visemc_1,visgsd_1,zbase_1,zceil_1,ztop_1,pw_1,pofp_1,qpf_1,qpf3_1,snow_1,snow6_1,ref1km_1,refc_1,clwmr_1,icmr_1,rwmr_1,snmr_1,grle_1,refd_1,tmphyb_1,sotyp_1,vgtyp_1,veg_1,tsoil_0_10_1,tsoil_10_40_1,tsoil_40_100_1,tsoil_100_200_1,soilw_0_10_1,soilw_10_40_1,soilw_40_100_1,soilw_100_200_1,swdown_1,swup_1,lwdown_1,lwup_1,gdhfx_1,lhfx_1,snhfx_1,hpbl_1,cond_1,tcolw_1,tcoli_1,hel3km_1,hel1km_1,uh25_1,uh03_1,maxuvv_1,maxdvv_1,maxref1km_1,maxref10C_1,maxwind_1,relv01_1,relv02_1,relvhyb_1,hindex_1,utrans_1,vtrans_1,trans_1,tcdc_1,retop_1,pbase_1,ptop_1,prate_1,tb_ch8,tb_ch9,tb_ch10,tb_ch13 = read_variables(dom)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1 = m.colorbar(cs_1,ax=ax,location='bottom',pad=0.05,ticks=[-40,-28,-16,-4,8,20,32,44,56,68,80,92,104,116,128],extend='both')
      cbar1.set_label(units,fontsize=6)
      cbar1.ax.tick_params(labelsize=5)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1 = m.colorbar(cs_1,ax=ax,location='bottom',pad=0.05,ticks=[-40,-30,-20,-10,0,10,20,30,40,50,60,70,80],extend='both')
      cbar1.set_label(units,fontsize=6)
...
#      ax.text(.5,1.03,'FV3LAM-X-X 2-m Relative Humidity ('+units+') \n initialized: '+itime+' valid: '+vtime + ' (f'+fhour+')',horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
#      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#      ax.text(.5,1.03,'FV3LAM-X-X - FV3LAM-X 2-m Relative Humidity ('+units+') \n initialized: '+itime+' valid: '+vtime + ' (f'+fhour+')',horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
#      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#      cbar2.set_label(units,fontsize=6)
#      cbar2.ax.tick_params(labelsize=6)
#      ax.text(.5,1.03,'FV3LAM-X-X Fosberg Index \n initialized: '+itime+' valid: '+vtime + ' (f'+fhour+')',horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
#      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#      cbar3.set_label(units,fontsize=6)
#      cbar3.ax.tick_params(labelsize=6)
#      ax.text(.5,1.03,'FV3LAM-X-X - FV3LAM-X Fosberg Index \n initialized: '+itime+' valid: '+vtime + ' (f'+fhour+')',horizontalalignment='center',fontsize=6,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
#      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)
...
#  urot_2, vrot_2 = m.rotate_vector(u850_2,v850_2,lon2,lat2)
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cs_1.cmap.set_under('white')
      cs_1.cmap.set_over('white')
      cbar1 = m.colorbar(cs_1,ax=ax,location='bottom',pad=0.05,ticks=[240,246,252,258,264,270,276,282,288,294,300,306,312,318,324,330,336,342,348,354,360],extend='both')
      cbar1.set_label(units,fontsize=6)   
      cbar1.ax.tick_params(labelsize=4)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cs_1.cmap.set_under('black')
      cs_1.cmap.set_over('white')
      cbar1 = m.colorbar(cs_1,ax=ax,location='bottom',pad=0.05,ticks=[180,200,220,240,260,280],extend='both')
      cbar1.set_label(units,fontsize=6)
      cbar1.ax.tick_params(labelsize=6)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cs_1.cmap.set_under('white')
      cs_1.cmap.set_over('white')
      cbar1 = m.colorbar(cs_1,ax=ax,location='bottom',pad=0.05,ticks=[180,200,220,240,260,280,300,320],extend='both')
      cbar1.set_label(units,fontsize=6)
      cbar1.ax.tick_params(labelsize=6)
