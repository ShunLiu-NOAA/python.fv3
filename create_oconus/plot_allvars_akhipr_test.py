...
# Define the input files - different based on which domain you are reading in!
  data1 = pygrib.open('/gpfs/dell2/emc/modeling/noscrub/Benjamin.Blake/test/rrfs_'+dom+'.grib2')
...
# 2-m temperature
  ...
  return slp_1,slpsmooth1,tmp2m_1
...
def plot_all(domain):
  ...
  global slp_1,slpsmooth1,tmp2m_1

  slp_1,slpsmooth1,tmp2m_1 = read_variables(dom)
