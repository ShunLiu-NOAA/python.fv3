...
if (fhr > 2):
  ...
  data3_m1 = pygrib.open('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhour1+'.grib2')
  ...
  data3_m2 = pygrib.open('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhour2+'.grib2')
...
if (fhr >= 6):
  ...
  try:
    ...
    print(('No HRRR data available for this forecast hour')) 
  data3_m6 = pygrib.open('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhour6+'.grib2')
...
if (fhr >= 24):
  ...
  try:
    ...
    print(('No HRRR data available for this forecast hour')) 
  data3_m24 = pygrib.open('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhour24+'.grib2')
...
lwdown_3 = data3.select(name='Downward long-wave radiation flux',stepType='instant')[0].values
lwdown_4 = data4.select(name='Downward long-wave radiation flux',stepType='instant')[0].values
...
def plot_all(domain):
  ...
  global fig,axes,ax1,ax2,ax3,ax4,keep_ax_lst_1,keep_ax_lst_2,keep_ax_lst_3,keep_ax_lst_4,m,x,y,x_shift,y_shift,xscale,yscale,im,im2,par
  fig,axes,ax1,ax2,ax3,ax4,keep_ax_lst_1,keep_ax_lst_2,keep_ax_lst_3,keep_ax_lst_4,m,x,y,x_shift,y_shift,xscale,yscale,im,im2,par = create_figure()
...
##  map.drawmeridians(meridians,labels=[0,0,0,1],fontsize=6)
  ...
  return fig,axes,ax1,ax2,ax3,ax4,keep_ax_lst_1,keep_ax_lst_2,keep_ax_lst_3,keep_ax_lst_4,m,x,y,x_shift,y_shift,xscale,yscale,im,im2,par
