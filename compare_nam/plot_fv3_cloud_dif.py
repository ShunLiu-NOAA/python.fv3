...
#  prodind = pygrib.open('/gpfs/dell3/stmp/Benjamin.Blake/fv3nam/'+ymdh+'/'+cyc+'/nam.t'+cyc+'z.conusnest.hiresf'+fhr+'.tm00.grib2')
  prodind = pygrib.open('/gpfs/dell1/nco/ops/com/nam/prod/nam.'+str(ymd)+'/nam.t'+cyc+'z.conusnest.hiresf'+fhr+'.tm00.grib2')
  paraind = pygrib.open('/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f'+fhr+'.grib2')
