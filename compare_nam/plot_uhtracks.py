...
PROD_DIR = '/gpfs/dell1/nco/ops/com/nam/prod/nam.'+ymd
PARA_DIR = '/gpfs/dell4/ptmp/emc.campara/fv3lam/fv3lam.'+ymd+'/'+cyc
...
#for j in range(len(vtime_list[0:7])):
    ...
    # Prod, para
    data1 = pygrib.open(PROD_DIR+'/nam.t'+cyc+'z.conusnest.hiresf'+fhour+'.tm00.grib2')
