...
if tmmark == 'tm00':
  vtime = ymdh
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm01.grib2')
elif tmmark == 'tm01':
  vtime = ncepy.ndate(itime,-1)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm01.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm02.grib2')
elif tmmark == 'tm02':
  vtime = ncepy.ndate(itime,-2)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm02.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm03.grib2')
elif tmmark == 'tm03':
  vtime = ncepy.ndate(itime,-3)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm03.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm04.grib2')
elif tmmark == 'tm04':
  vtime = ncepy.ndate(itime,-4)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm04.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm05.grib2')
elif tmmark == 'tm05':
  vtime = ncepy.ndate(itime,-5)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm05.grib2')
  gesdata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f01.tm06.grib2')
elif tmmark == 'tm06':
  vtime = ncepy.ndate(itime,-6)
  anldata = pygrib.open('/gpfs/dell2/ptmp/emc.campara/fv3lamdax/fv3lamdax.'+str(ymd)+'/'+cyc+'/fv3lam.t'+cyc+'z.conus.f00.tm06.grib2')
  ...
  # Clear off old plottables but keep all the map info
    ...
    for ax in axes:
      ...
      if par == 1:
        ...
        cbar1.ax.tick_params(labelsize=7)
        ax.text(.5,1.04,'LAMDA-X Hybrid Level 1 Specific Humidity ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
        ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

      par += 1
    par = 1

    compress_and_save('lamdax_qlvl1_'+dom+'_'+tmmark+'.png')
    t2 = time.clock()
    t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X Surface Pressure ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_slp_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.set_label(units,fontsize=8)
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X Precipitable Water ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_pw_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 850 hPa Geopotential Height ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_z850_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-40,-30,-25,-20,-16,-12,-8,-4,0,4,8,12,16,20,25,30,40])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 700 hPa Geopotential Height ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_z700_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-40,-30,-25,-20,-16,-12,-8,-4,0,4,8,12,16,20,25,30,40])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 500 hPa Geopotential Height ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_z500_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-40,-30,-25,-20,-16,-12,-8,-4,0,4,8,12,16,20,25,30,40])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 250 hPa Geopotential Height ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_z250_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 850 hPa Temperature ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_t850_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 700 hPa Temperature ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_t700_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 500 hPa Temperature ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_t500_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 250 hPa Temperature ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_t250_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,-0.25,-0.1,0,0.1,0.25,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 850 hPa Specific Humidity ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_q850_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,-0.25,-0.1,0,0.1,0.25,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 700 hPa Specific Humidity ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_q700_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      cbar1.ax.set_xticklabels([-5,-4,-3,-2.5,-2,-1.5,-1,-0.5,-0.25,-0.1,0,0.1,0.25,0.5,1,1.5,2,2.5,3,4,5])
      cbar1.ax.tick_params(labelsize=7)
      ax.text(.5,1.04,'LAMDA-X 500 hPa Specific Humidity ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+')',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_q500_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.06,'LAMDA-X 850 hPa Wind Speed ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+') \n Analysis(black), First Guess (pink)',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_wspd850_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.06,'LAMDA-X 700 hPa Wind Speed ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+') \n Analysis(black), First Guess (pink)',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_wspd700_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.06,'LAMDA-X 500 hPa Wind Speed ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+') \n Analysis(black), First Guess (pink)',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_wspd500_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
...
#################################
  ...
  for ax in axes:
    ...
    if par == 1:
      ...
      ax.text(.5,1.06,'LAMDA-X 250 hPa Wind Speed ('+units+') \n '+itime+' cycle, Valid: '+vtime+' ('+tmmark+') \n Analysis(black), First Guess (pink)',horizontalalignment='center',fontsize=10,transform=ax.transAxes,bbox=dict(facecolor='white',alpha=0.85,boxstyle='square,pad=0.2'))
      ax.imshow(im,aspect='equal',alpha=0.5,origin='upper',extent=(0,int(round(xmax*xscale)),0,int(round(ymax*yscale))),zorder=4)

    par += 1
  par = 1

  compress_and_save('lamdax_wspd250_'+dom+'_'+tmmark+'.png')
  t2 = time.clock()
  t3 = round(t2-t1, 3)
